...
export default function Sidebar() {
    ...
    return (
        <div className="ml-[0px] md:mt-[68px] flex h-full rounded fixed z-[100] md:max-h-[91%] bg-transparent md:bg-white">
            <div
                onMouseLeave={() => {
                    isExpanded ? setShowReportsSubmenu(false) : null;
                    setIsExpanded(false);
                }}
            ...
            >
                ...
                <div className={`flex flex-col mt-[18px] ${isExpanded ? 'ml-[0px] min-w-[200px] max-w-[200px]' : 'md:w-20'}`}>
                                    ...
                                    {isExpanded ? (
                                        ...
                                        <>
                                            <button
                                                title={item.label}
                                                type="button"
                                                className="flex py-[15px] items-center justify-center hover:bg-opacity-75 w-full"
                                                style={{ backgroundColor: currentPath === item.path ? primary : 'transparent', color: currentPath === item.path ? secondary : primary }}
                                                onClick={() => setShowReportsSubmenu(!showReportsSubmenu)}
                                            >
                                                <item.icon size={24} />
                                            ...
                                            {showReportsSubmenu && (
                                                <div
                                                    className="absolute left-full top-0 ml-2 mt-2 bg-white shadow-lg border rounded-lg p-2 z-50"
