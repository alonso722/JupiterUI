        ...
        <Calendar
          ...
          {showModalReq && (
            ...
            className={`text-black ml-5 mt-6 max-w-[90%] max-h-[485px] shadow-lg px-6 pt-5 pb-2 flex flex-col ${
              permissions.isManager == 1 || permissions.isRh == 1 || permissions.isManager === 1 || permissions.isRh === 1 ? 'divide-y divide-gray-300' : ''
            }`}
          >
            ...
            <div className={`flex-1 ${permissions.isManager == 1 || permissions.isRh == 1 || permissions.isManager === 1 || permissions.isRh === 1 ? 'mt-4' : ''} flex flex-col`}>
              <div className='flex min-w-[260px]'>
