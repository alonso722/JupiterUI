        ...
        <div className="flex h-11 w-[20px] flex-row items-center">
                                    ...
                                    <Menu.Item>
                                        {({ active }) => (
                                            <button
                                                ...
                                                <div className={`flex pl-[20px] pr-[45px] my-[5px] ${active ? 'bg-gray-100 text-gray-900' : 'text-gray-700'}`}>
                                                    <Image
                                                        className="mr-[20px]"
                                                        src="/icons/pencil.svg"
                                                        alt="image"
            ...
            {isDeleteModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-[#2C1C47] bg-opacity-30">
                    ...
                    <p className="mb-[20px] text-center text-black" style={{ textTransform: 'none' }}>¿Estás seguro que deseas eliminar el usuario?</p>
