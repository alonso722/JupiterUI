                                    ...
                                    <Menu.Item>
                                        {({ active }) => (
                                            <button
                                                ...
                                                <div className={`flex pl-[20px] pr-[56px] pr-[56px] my-[5px] ${active ? 'bg-gray-100 text-gray-900' : 'text-gray-700'}`}>
                                                    <Image
                                                        className="mr-[30px]"
                                    ...
                                    <Menu.Item>
                                        {({ active }) => (
                                            <button
                                                ...
                                                <div className={`flex pl-[20px] pr-[56px] pr-[36px] my-[5px] ${active ? 'bg-gray-100 text-gray-900' : 'text-gray-700'}`}>
                                                    <Image
                                                        className="mr-[30px]"
                                                        src="/icons/trash.svg"
                                                        alt="image"
