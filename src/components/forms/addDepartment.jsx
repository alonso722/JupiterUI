...
const AddDepartmentForm = ({ onClose, rowData }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#2C1C47] bg-opacity-30 px-5 md:px-0">
      <div className="bg-white p-6 rounded-lg shadow-lg md:bw-[500px] md:h-[500px] relative">
        ...
        <div className="flex justify-end">
          {data.id ? (
            <button 
              ...
              className="px-2 rounded text-white ml-5 mr-[20px] py-1 md:w-[250px] mt-[0px]"
            ...
            <button 
              ...
              className="px-2 rounded text-white ml-5 mr-[20px] py-1 md:w-[250px] mt-[30px]"
              style={{ backgroundColor: secondary }}
            >
              Añadir departamento
            </button>
