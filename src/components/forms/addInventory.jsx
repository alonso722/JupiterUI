...
const AddInventoryForm = ({ onClose, rowData }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#2C1C47] z-50 bg-opacity-30 px-[35px]">
      <div className="bg-white p-6 rounded-lg shadow-lg md:w-[500px] w-full h-[60%] relative">
